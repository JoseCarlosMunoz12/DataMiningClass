...
\begin{tikzpicture}
  \node[state](a) at (0,0) {Z};
  
  \node[state](b)[below left =of a]{X/Y};  
  \node[state](c)[below right =of a]{X/Y};
  
  \node[state](d)[below left =of b]{C2};  
  \node[state](e)[below =of b]{C2};
  
  \node[state](f)[below =of c]{C1};  
  \node[state](g)[below right =of c]{C1};
...
\begin{tikzpicture}
  \node[state](a) at (0,0) {X};  
  \node[state](b)[below left =of a]{Y};  
  \node[state](c)[below right =of a]{Y};  
  \node[state](d)[below left =of b]{C2};  
  \node[state](e)[below =of b]{C1};  
  \node[state](f)[below =of c]{C1};  
  \node[state](g)[below right =of c]{C2};  
  \path[->,draw,thick]
  (a)edge node{0}(b)
  (a)edge node{1}(c)
  (b)edge node{0}(d) 
