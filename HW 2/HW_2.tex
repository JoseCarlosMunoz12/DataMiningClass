...
3.7a)\\
P(A=1 $\vert$-)=2/5=0.4 , P(A=1 $\vert$+)=3/5=0.6 , P(A=0 $\vert$-)=3/5=0.6 , P(A=0 $\vert$+)=2/5=0.4\\
P(B=1 $\vert$-)=2/5=0.4 , P(B=1 $\vert$+)=1/5=0.2  , P(B=0 $\vert$-)=3/5=0.6 , P(B=0 $\vert$+)=4/5=0.8\\
P(C=1 $\vert$-)=4/4=1.0 , P(C=1 $\vert$+)=4/5=0.8 , P(C=0 $\vert$-)=0/4=0.0 , P(C=0 $\vert$+)=1/5=0.2\\
\\
%===============================
%===============================
3.7b)\\
